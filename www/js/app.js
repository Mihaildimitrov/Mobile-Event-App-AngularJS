...
angular.module('app', ['ionic', 'app.controllers', 'app.routes', 'app.directives', 'app.services', 'tutorials', 'ngSanitize', 'ApiUrlModule', 'FormSevice', 'encodeDecodeBase64', 'authenticationModule', 'userInfo', 'webStorageSevrice', 'ionic.native'])
